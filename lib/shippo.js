...
Shippo.prototype = {
  ...
  setToken: function (token) {
    const shippoToken = typeof token === "object" ? token.shippoToken : token;
    const oauthToken = typeof token === "object" ? token.oauthToken : undefined;
  ...
  _init: function () {
    for (let name in Shippo.resources) {
